...
class Request extends \yii\base\Request
{
    ...
    {
//        $_GET = $this->workermanRequest->get();
    ...
    {
        return $this->workermanRequest->method();
        if (
...
//            $this->_rawBody = file_get_contents('php://input');
            $this->_rawBody = $this->workermanRequest->rawBody();
        }
    ...
    {
//        $_POST = $this->workermanRequest->post();
    ...
    {
        if ($this->_queryParams === null) {
            return $this->workermanRequest->get();
        }
    ...
    {
        return $this->workermanRequest->uri();
    ...
    {
        return $this->workermanRequest->queryString();
    ...
    {
        return $this->workermanRequest->host();
    ...
    {
        $_COOKIE = $this->workermanRequest->cookie();
        $cookies = [];
